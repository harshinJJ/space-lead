...
export const PrimaryDualTextLink = ({
  ...
  return (
    <Link
      {...props}
      href={href}
      className={`text-white flex justify-center bg-linear-to-r from-[#5AC0BE] to-[#7F529F] rounded-full w-fit group px-3.5 py-4.25 items-center gap-2 hover:from-[#B20D5D] hover:to-[#4A0AB4] transition-all duration-300 ${className}`}
    >
