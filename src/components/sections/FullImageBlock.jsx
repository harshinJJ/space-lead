...
const FullImageBlock = ({ title = "Find us", label, className = "", url }) => {
  return (
    <section className={`bg-indigo lg:py-15 py-5 text-white ${className}`}>
      <div
        className={`container-fluid mx-auto text-[1.13rem] bg-cover bg-center bg-no-repeat flex-3 flex flex-col gap-3 md:gap-7.5 px-5 xl:px-0 rounded-3xl `}
      >
        ...
        {url && <div data-aos="zoom-in" data-aos-once="true" className="bg-white rounded-xl overflow-hidden">
