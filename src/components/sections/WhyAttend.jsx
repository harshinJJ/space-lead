...
const WhyAttend = ({ children }) => {
  return (
    <section className="relative overflow-hidden bg-[top_center] bg-indigo bg-cover bg-no-repeat py-10 sm:py-20 px-1 xs:px-4">
      <BgOverlay/>
      <div className="relative container-fluid mx-auto px-2 lg:ps-15.75 xs:px-4 lg:pe-0 rounded-t-4xl bg-gradient-to-b from-secondary via-secondary/50 via-[40%] to-transparent to-[50%] pt-22.5 text-white">
