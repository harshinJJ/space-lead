...
const HomeBanner = () => {
  ...
  return (
    <section id="home-banner" className="bg-[url('/images/home_banner.png')] bg-[bottom_center] bg-cover bg-no-repeat py-20 pt-54 text-white">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center justify-between">
          <div className="flex-2 flex flex-col gap-5 font-gilroy-med">
            ...
            <div className="flex flex-col md:flex-row gap-x-10 gap-y-4">
              <div className="flex items-center gap-2 py-1 px-5 rounded-full bg-linear-to-r from-[#90D3D012] to-[#FFFFFF12] w-fit">
                <svg
                  width="46"
                  height="45"
                  viewBox="0 0 46 45"
                ...
                <span className="md:text-nowrap">Nov 09, 10, 11 - 2025</span>
              </div>
              <div className="flex items-center gap-2 py-1 px-5 rounded-full bg-linear-to-r from-[#90D3D012] to-[#FFFFFF12] w-fit">
                <svg
                  width="35"
            ...
            <div className="flex flex-col gap-6.5">
              ...
              <div className="flex flex-col md:flex-row items-center gap-10">
                {Object.entries(remainingTime).map(([key, value]) => (
                  <div
                    key={key}
                    className="flex-1 min-w-25 flex items-center flex-col justify-center aspect-square w-fill rounded-full bg-[#ffffff08]"
                  >
                    <h5 className="text-5xl leading-[100%] text-[#90D3D0]">{String(value).padStart(2, "0")}</h5>
