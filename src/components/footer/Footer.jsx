  ...
  return (
    <footer className="relative bg-black bg-cover bg-center bg-no-repeat text-white">
      ...
      >
        ...
        <section className="relative py-10 border-b border-[#CCCCCC33] flex flex-col gap-y-10 xs:flex-row justify-between gap-40">
          ...
          <div className="flex-1 w-fit flex flex-col sm:gap-10 gap-5">
          ...
          <div className="flex-2 flex flex-col sm:gap-10 gap-5">
            <h4 className="text-[1.5rem] font-medium">Quick Links</h4>
            <ul className="grid grid-cols-2 xs:text-sm sm:text-base sm:grid-cols-3 gap-y-2.5 leading-[1.8] gap-x-12.5 w-fit">
          ...
          <div className="flex-1 flex flex-col sm:gap-10 gap-5">
            <div className="flex flex-col sm:gap-10 gap-5">
              <h4 className="text-[1.5rem] font-medium">Contact Us</h4>
        ...
        <div className="text-center py-10 flex flex-col-reverse gap-2 md:flex-row items-center justify-between">
