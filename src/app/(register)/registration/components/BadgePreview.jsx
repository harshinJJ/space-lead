    ...
    <div className="bg-white uppercase rounded-[1.25rem] overflow-hidden flex flex-col items-center w-full max-w-xs">
      ...
      <div className="flex flex-col items-center p-5.5 max-w-full">
        <div className="mb-2">
          ...
          <div className="relative bg-[#F0F0F0] p-1 rounded-sm aspect-square min-w-33 flex items-center justify-center opacity-50">
        ...
        <div
          className={`font-azonix text-center ${
            name?.length > 10 ? "text-xl break-all " : "text-3xl"
          } mb-1`}
        >
          {name || "FULL NAME"}
        </div>
