...
const ExhibitContent = () => (
  <section className="container mx-auto gap-y-10 w-full flex flex-col lg:flex-row items-start px-5 sm:px-0 lg:p-8  py-10 relative overflow-hidden">
    ...
    <div className="w-full lg:w-3/5 flex flex-col justify-center lg:pl-8">
      ...
      <p className="text-base lg:text-lg text-gray-700 leading-relaxed">
        ...
        Conference where industry innovators, decision-makers, and stakeholders
        connect with high-value prospects, strategic partners, and new markets,
        all under a single platform. Tap into high-impact opportunities in the
